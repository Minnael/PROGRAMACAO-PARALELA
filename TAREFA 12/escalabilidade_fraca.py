...
tempos = [23.5101, 24.7061, 24.7288, 28.101, 29.9336, 31.1306]
...
# Speedup Fraco
plt.subplot(1, 2, 1)
plt.plot(threads, speedups_weak, marker='^', color='purple', label='Speedup Fraco')
...
# Eficiência Fraca
plt.subplot(1, 2, 2)
plt.plot(threads, [e * 100 for e in eficiencias_weak], marker='^', color='red', label='Eficiência Fraca (%)')
